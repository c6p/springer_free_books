...
If you want to mannually set a folder to download, insert `folder = 'C:/desired_folder/'` in line 38 in main.py.
...
It took more than 4 hours to complete the 407 english books (~15 GB, both PDF and epub) on my machine.
